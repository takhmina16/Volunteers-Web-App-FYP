<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Main/Users-Login.Master" AutoEventWireup="true" CodeBehind="sign_up.aspx.cs" Inherits="FYP_Volunteering.User_Login_Register.sign_up" %>
            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                     ...
                     <div class="col">
                        <div class="form-group">
                            <asp:Button ID="Button1" class="btn btn-lg btn-block btn-warning" runat="server" Text="Sign Up" OnClick="Button1_Click" />
                        </div>
                     </div>
                  </div>
                ...
                <a href="user_login.aspx"><< Back to Login Page<br><br>
            </div>
        </div>
    </div>
    <br /> <br /> 
