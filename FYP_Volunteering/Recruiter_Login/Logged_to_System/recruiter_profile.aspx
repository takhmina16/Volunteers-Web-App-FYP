<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Main/Recruiter/Recruiter.Master" AutoEventWireup="true" CodeBehind="recruiter_profile.aspx.cs" Inherits="FYP_Volunteering.Recruiter_Login.Logged_to_System.recruiter_profile" %>
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <asp:Label class="badge badge-pill badge-info" ID="Label1" style="color: darkseagreen;"
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Issued Volunteering Experiences</h4>
