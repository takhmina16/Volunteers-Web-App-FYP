...
namespace FYP_Volunteering.Recruiter_Login.Logged_to_System
{
    public partial class recruiter_profile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE user_info_tbl set full_name=@full_name, dob=@dob, contact_no=@contact_no," +
                    " email=@email, country=@country, city=@city, pincode=@pincode, full_address=@full_address, " +
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT * from user_info_tbl where member_id='" +
        ...
        void getUserExperienceData()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from experience_issue_tbl " +
                    "where user_id='" + Session["username"].ToString() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
