<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Main/Users-Login.Master" AutoEventWireup="true" CodeBehind="recruiter_signup.aspx.cs" Inherits="FYP_Volunteering.Recruiter_Login.recruiter_signup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br /> 
    <div class="container" style="background-image: url('../img/gifs/2.gif');">
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="../img/user/generaluser.png" width="100px;" alt="usericon" /> 
                                </center>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group"> 
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server"
                                        placeholder="Enter DOB" TextMode="Date"></asp:TextBox>
                                </div>  
                            </div>
                        </div>
                        <!-- Contact No --> 
                     ...
                     <div class="col">
                        <div class="form-group">
                            <asp:Button ID="Button1" class="btn btn-lg btn-block btn-warning" runat="server" Text="Sign Up" OnClick="Button1_Click1" />
                        </div>
                     </div>
                  </div>
                ...
                <a href="recruiter_login.aspx"/><< Back to Login Page<br><br>
            </div>
        </div>
    </div>
    <br /> <br /> 
