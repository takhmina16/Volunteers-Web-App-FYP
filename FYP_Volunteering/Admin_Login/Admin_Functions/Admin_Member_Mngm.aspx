<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Main/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="Admin_Member_Mngm.aspx.cs" Inherits="FYP_Volunteering.Admin_Member_Mngm" %>
            ...
            <div class="card" style="margin-left:40px;">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="95px" src="../../img/user/generaluser.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:evolunteerDBConnectionString2 %>" SelectCommand="SELECT * FROM [user_info_tbl]"></asp:SqlDataSource>
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered table-responsive" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="SqlDataSource1">
                            <Columns>
